class CustomSet:
    ...
    def __contains__(self, item):
        ...
        if item in self._L[index]: return True
    ...
    def add(self, item):
        ...
        if len(self._L) == (self._n_buckets * 2): self._rehash(self._n_buckets * 2)
    ...
    def remove(self, item):
        ...
        if item not in self: raise KeyError('Item not in Set')
        ...
        if len(self._L) == (self._n_buckets * .5): self._rehash(self._n_buckets * .5)
    ...
    def _rehash(self, new_buckets):
        ...
        list = [[] for _ in range(new_buckets)]
        ...
        for bucket in self._L:
            ...
            for item in bucket:
                ...
                list[new_bucket_index].append(item)
